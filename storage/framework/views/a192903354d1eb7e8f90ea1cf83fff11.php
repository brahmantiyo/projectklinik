                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('patients.store')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no" id="no" class="form-control <?php $__errorArgs = ['no'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('no')); ?>">
                            <?php $__errorArgs = ['no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="age" id="age" min="0" class="form-control <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo e(route('patients.index')); ?>" class="btn btn-secondary">Batal</a>
...
<?php echo $__env->make('layouts.app', ['title' => 'Tambah Pasien'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project_klinik/resources/views/patients/create.blade.php ENDPATH**/ ?>